...
> Container for running frigate with coral edge tpu support

## Links
- [Official Documentation](https://docs.frigate.video/frigate/installation/)
- [Service Configuration](https://github.com/traefikturkey/onramp/tree/main/services-available/frigate-coral.yml)
