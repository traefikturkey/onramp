...
create-external: ## Create external service from template
	envsubst '$${SERVICE_PASSED_DNCASED},$${SERVICE_PASSED_UPCASED}' < ./services-scaffold/_templates/external.template > ./etc/traefik/available/$(SERVICE_PASSED_DNCASED).yml
